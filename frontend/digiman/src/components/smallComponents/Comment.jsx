...
export default function Comment({name = 'Guest', text = '', created_at = null, avatar = null, onClick, className, isOwner = false, onEdit, onDelete, imageUrl}){
    ...
    return (
        <div className={`comment-rect ${className||''}`} onClick={onClick}>
            <div className="comment-row">
                ...
                <div className="flex-grow-1">
                    ...
                    <div className="comment-body" dangerouslySetInnerHTML={{__html: sanitizeHTML(text)}} />
                    {imageUrl && (
                        <div className="mt-2">
